...
const messageInputView = require('./componets/message-input/template.vue');
const roomsView = require('./components/rooms/template.vue');
const roomMenuView = require('./components/room-menu/template.vue');
